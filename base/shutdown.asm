 ...
 348:	89 d1                	mov    %edx,%ecx
{
 ...
 37b:	0f b6 92 70 07 00 00 	movzbl 0x770(%edx),%edx
 ...
 3e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 454:	ff 24 85 18 07 00 00 	jmp    *0x718(,%eax,4)
 ...
 55b:	52                   	push   %edx
 55c:	57                   	push   %edi
 55d:	e8 31 fd ff ff       	call   293 <write>
        ap++;
 ...
 580:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 585:	bb 0e 07 00 00       	mov    $0x70e,%ebx
...
free(void *ap)
{
 ...
 591:	a1 0c 0a 00 00       	mov    0xa0c,%eax
{
 ...
 5d1:	5b                   	pop    %ebx
  freep = p;
 5d2:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
}
 5d8:	5e                   	pop    %esi
 5d9:	5f                   	pop    %edi
 5da:	5d                   	pop    %ebp
 ...
 607:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 60a:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66b:	39 05 0c 0a 00 00    	cmp    %eax,0xa0c
 ...
 68e:	e8 fd fe ff ff       	call   590 <free>
  return freep;
 693:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
}
 ...
 6cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6d0:	c7 05 0c 0a 00 00 10 	movl   $0xa10,0xa0c
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	b8 10 0a 00 00       	mov    $0xa10,%eax
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 10 0a 00 00 10 	movl   $0xa10,0xa10
 6e6:	0a 00 00 
    base.s.size = 0;
 6e9:	c7 05 14 0a 00 00 00 	movl   $0x0,0xa14
 6f0:	00 00 00 
    if(p->s.size >= nunits){
