...
int main(int argc, char ** argv)
{
  ...
  2b:	50                   	push   %eax
  2c:	68 58 07 00 00       	push   $0x758
  31:	6a 02                	push   $0x2
  33:	e8 f8 03 00 00       	call   430 <printf>
  ...
  4e:	83 c3 01             	add    $0x1,%ebx
        printf(STDERR, "%s ", argv[i]);
  51:	68 65 07 00 00       	push   $0x765
  56:	6a 02                	push   $0x2
  58:	e8 d3 03 00 00       	call   430 <printf>
    for (i = 1; i < argc ; i++)
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d5:	bb 6b 07 00 00       	mov    $0x76b,%ebx
 ...
 5e1:	a1 74 0a 00 00       	mov    0xa74,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 74 0a 00 00    	mov    %edx,0xa74
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 657:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65a:	89 15 74 0a 00 00    	mov    %edx,0xa74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6bb:	39 05 74 0a 00 00    	cmp    %eax,0xa74
