...
int add_to_hist (char *input, int count){
	
	/*
	for(int i = 0; i < 9; i++){
		//printf(2, "first second %s/n %s/n", command_history[i], command_history[i+1]);
	       // either use strcpy or "=" operator but not working
